...
import com.android.volley.aa.SurfaceControl;
...
class GlobalScreenshot {
    ...
    public GlobalScreenshot(Context context) {
        ...
        mBgPadding = (float) r.getDimensionPixelSize(R.dimen.px_40);
    ...
    public void takeScreenshot(View view, Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        ...
        File filePath =new File(Constant.IMAGE_PATH + UUID.randomUUID().toString() + ".jpg");
        if (filePath == null) {
            return;
        }
        ...
        ScreenShoot.savePic(mScreenBitmap, filePath);
